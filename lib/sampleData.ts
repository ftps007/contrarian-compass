...
// This data is pre-calculated to avoid API costs
...
export const samplePortfolioData = {
  ...
  weeks: [
    ...
    },
    {
      ...
      positions: [
        { ticker: 'HD', shares: 84, execPrice: 380.17, endPrice: 385.42, costBasis: 31934.28 },
        { ticker: 'UNH', shares: 19, execPrice: 331.02, endPrice: 338.55, costBasis: 6289.38 },
        { ticker: 'PG', shares: 10, execPrice: 144.53, endPrice: 146.21, costBasis: 1445.30 },
        { ticker: 'KO', shares: 140, execPrice: 70.44, endPrice: 71.15, costBasis: 9861.60 },
        { ticker: 'JNJ', shares: 133, execPrice: 218.66, endPrice: 221.34, costBasis: 29081.78 },
        { ticker: 'AMGN', shares: 70, execPrice: 330.41, endPrice: 334.18, costBasis: 23128.70 },
        { ticker: 'VZ', shares: 64, execPrice: 38.91, endPrice: 39.45, costBasis: 2490.24 },
      ],
      trades: [
        { ticker: 'HD', action: 'BUY', shares: 9, price: 380.17, value: 3421.53 },
        { ticker: 'UNH', action: 'SELL', shares: 3, price: 331.02, value: 993.06 },
        { ticker: 'PG', action: 'BUY', shares: 10, price: 144.53, value: 1445.30 },
        { ticker: 'KO', action: 'BUY', shares: 20, price: 70.44, value: 1408.80 },
        { ticker: 'JNJ', action: 'BUY', shares: 10, price: 218.66, value: 2186.60 },
        { ticker: 'AMGN', action: 'SELL', shares: 9, price: 330.41, value: 2973.69 },
        { ticker: 'VZ', action: 'SELL', shares: 56, price: 38.91, value: 2178.96 },
      ],
      dividends: [],
      portfolioValue: {
        start: 104587.90,
        end: 106152.43,
        stockValue: 105438.15,
        cash: 714.28,
        dividends: 0,
      },
      weeklyReturn: 0.0150,
  ...
  summary: {
    ...
    finalValue: 106152.43,
  },

  metrics: {
    tangency: {
      totalReturn: 0.0615,
      meanWeeklyReturn: 0.0201,
      weeklyVolatility: 0.0056,
      sharpeRatio: 3.45,
      beta: 0.31,
      alpha: 0.0168,
    },
    equalWeight: {
      totalReturn: 0.0341,
      meanWeeklyReturn: 0.0112,
      weeklyVolatility: 0.0118,
      sharpeRatio: 0.89,
      beta: 0.72,
      alpha: 0.0048,
    },
  ...
  returnComparison: [
    { name: 'Week 1', tangency: 2.62, equalWeight: 2.26, dji: 2.32 },
    { name: 'Week 2', tangency: 1.92, equalWeight: 0.41, dji: -0.29 },
    { name: 'Week 3', tangency: 1.50, equalWeight: 0.72, dji: 0.42 },
  ],
  ...
  portfolioValueHistory: [
    ...
    { date: 'Jan 23', tangency: 106152, equalWeight: 103418, dji: 102449 },
  ],
};
